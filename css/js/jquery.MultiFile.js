...
if (window.jQuery)(function ($) {
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		STRING: {
			remove: 'x',
			denied: 'Rozszerzenie $ext jest niedozwolone.\nSpróbuj ponownie...',
			file: '$file',
			selected: 'Plik wybrany: $file',
			duplicate: 'Ten plik został juz wybrany:\n$file',
			toomuch: 'Pliki przekraczają maksymalny dozwolony rozmiar ($size)',
			toomany: 'Za dużo plików wybranych (max: $max)',
			toobig: 'Plik $file jest za duży (max $size)'
		},
